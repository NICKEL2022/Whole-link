...
if(isset($_POST['Submit-TV'])){
    ...
    if($_POST['Device_Status_TV']=='1'){
        $detail= "Android TV turn on , it's volume is ".$_POST['Volume_TV']." and brightness is ".$_POST['Brightness_TV'].".";
    }else{
        $detail= "Android TV turn off , it's volume is ".$_POST['Volume_TV']." and brightness is ".$_POST['Brightness_TV'].".";
    }
